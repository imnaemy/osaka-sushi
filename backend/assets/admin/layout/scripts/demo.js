...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        $('.toggler', panel).click(function() {
            $('.toggler').hide();
            $('.toggler-close').show();
            $('.theme-admin > .theme-options').show();
        });

        $('.toggler-close', panel).click(function() {
            $('.toggler').show();
            $('.toggler-close').hide();
            $('.theme-admin > .theme-options').hide();
        });
    ...
    return {
        ...
        init: function() {
            ...
            $('.theme-admin .layout-style-option').change(function() {
            ...
            if ($.cookie && $.cookie('layout-style-option') === 'rounded') {
                ...
                $('.theme-admin .layout-style-option').val($.cookie('layout-style-option'));
            }            
        }
    };
